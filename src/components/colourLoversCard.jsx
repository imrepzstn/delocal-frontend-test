      ...
      <div className="colour-card-container">
        <div className="colour-card-data">
          <div className="card-title">
            {this.props.ColourLoversCard.title.substring(0, 17)}
          </div>
          <div className="card-username">
            by {this.props.ColourLoversCard.userName} at{" "}
            {new Date(
              this.props.ColourLoversCard.dateCreated
          ...
          <div className="card-votes-container">
            <span className="card-votes">
              {this.props.ColourLoversCard.numViews} views{" "}
              {this.props.ColourLoversCard.numVotes} votes
            </span>
          </div>
        </div>
